...
# VSCode 中的双链笔记：Foam 使用体验

> 这条笔记更新于: 2022 年 10 月 24 日，星期一，13: 34。

## 配置笔记库

### 在 GitHub 上建立笔记库

使用 [foam-template-gatsby-kb](https://github.com/hikerpig/foam-template-gatsby-kb) 模版在自己的 GitHub 上建立仓库，可以选择是否将仓库设为私有库。仓库建立后，将其 clone 到本地并在 VSCode 中打开。这样以后就可以通过 GitHub 对你的笔记库进行版本控制，也可以[[通过 Github Pages 发布笔记]]。
...
[通过 Github Pages 发布笔记]: <../others/通过 Github Pages 发布笔记.md> "通过 Github Pages 发布笔记"
[snippets]: snippets.md "snippets"
[PicGo 图床设置]: <../others/PicGo 图床设置.md> "PicGo 图床设置"
[记笔记时常用的快捷键]: ../others/记笔记时常用的快捷键.md "记笔记时常用的快捷键"
